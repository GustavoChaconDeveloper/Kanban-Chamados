<h1 align="center">🧩 Sistema de Gestão de Chamados (Kanban)</h1>
...
<p>
Ao abrir um chamado via formulário, ele automaticamente se torna um card dentro do fluxo, permitindo acompanhamento em tempo real pela equipe.
</p>
